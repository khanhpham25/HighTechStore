					...
					<div class="col-md-9">
						<div class="row products">
							...
							<div class="col-md-4 col-sm-6">
								<div class="product">
									<div class="image">
										<a href="<%= request.getContextPath() %>/product?id=<%= listProduct.get(i).getMaSP() %>"> <img style="height: 220px; width: 250px"
									...
									<div class="text">
										<h3>
											<a href="<%= request.getContextPath() %>/product?id=<%= listProduct.get(i).getMaSP() %>"><%=listProduct.get(i).getTenSP()%></a>
										</h3>
										<p class="price"><%= new DecimalFormat("#,###,###,###").format(listProduct.get(i).getGiaSP()) %> VNĐ</p>
										<p class="buttons">
											<a href="<%= request.getContextPath() %>/product?id=<%= listProduct.get(i).getMaSP() %>" class="btn btn-default">Xem chi tiết</a>
										</p>
									</div>
									<!-- /.text -->
								</div>
					...
					<div class="col-md-3">
						...
						<div class="panel panel-default sidebar-menu">
                            <div class="panel-heading">
                                <h3 class="panel-title">Lọc theo thương hiệu</h3>
                            </div>

                            <div class="panel-body row">
                                <ul style="font-size: 18px;" class="nav">
                                <%
                                ArrayList<ThuongHieu> listBrand = (ArrayList<ThuongHieu>) request.getAttribute("listBrand");
                                for(int i = 0; i < listBrand.size(); i++){
                                	%>
                                	<li class="col-md-6"><a href="<%= request.getContextPath()%>/product-list?cateid=<%= cateid %>&brandid=<%= listBrand.get(i).getMaThuongHieu()%>&page=1"><%= listBrand.get(i).getTenThuongHieu() %></a></li>
                                	<%
                                }
                                %>
                                </ul>
