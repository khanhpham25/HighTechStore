					...
					<div class="x_panel">
						...
						<div class="x_content">
							<table id="datatable-buttons"
								...
								<tbody>
									<%
										ArrayList<MauSac> list = (ArrayList<MauSac>) request.getAttribute("list");
										for (int i = 0; i < list.size(); i++) {
									%>
									<tr>
										<td><%=list.get(i).getTenMau()%></td>
										<td width="120px;"><a
											href="<%=request.getContextPath()%>/admin/color?task=delete&id=<%=list.get(i).getMaMau()%>"
						...
						<a href="<%=request.getContextPath()%>/admin/color?task=create"
