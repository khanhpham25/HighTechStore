					...
					<div class="x_panel">
						...
						<div class="x_content">
							<table id="datatable-buttons"
								...
								<tbody>
									<%
										ArrayList<DanhMucBaiViet> list = (ArrayList<DanhMucBaiViet>) request.getAttribute("list");
										for (int i = 0; i < list.size(); i++) {
									%>
									<tr>
										<td><%=list.get(i).getTenDanhMuc()%></td>
										<td width="120px;"><a
											href="<%=request.getContextPath()%>/admin/article-category?task=edit&id=<%=list.get(i).getMaDanhMuc()%>"
											class="btn btn-primary">Sửa</a> <a
											href="<%=request.getContextPath()%>/admin/article-category?task=delete&id=<%=list.get(i).getMaDanhMuc()%>"
						...
						<a
							href="<%=request.getContextPath()%>/admin/article-category?task=create"
