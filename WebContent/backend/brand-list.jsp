					...
					<div class="x_panel">
						...
						<div class="x_content">
							<table id="datatable-buttons"
								...
								<tbody>
									<%
										ArrayList<ThuongHieu> list = (ArrayList<ThuongHieu>) request.getAttribute("list");
										for (int i = 0; i < list.size(); i++) {
									%>
									<tr>
										<td><%=list.get(i).getTenThuongHieu()%></td>
										<td width="120px;"><a
											href="<%=request.getContextPath()%>/admin/brand?task=edit&id=<%=list.get(i).getMaThuongHieu()%>"
											class="btn btn-primary">Sửa</a> <a
											href="<%=request.getContextPath()%>/admin/brand?task=delete&id=<%=list.get(i).getMaThuongHieu()%>"
						...
						<a href="<%=request.getContextPath()%>/admin/brand?task=create"
