		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="form-horizontal">
					...
					<hr />
					<form method="post"
						action="<%=request.getContextPath()%>/admin/orderform">
						<%
							DonHang e = (DonHang) request.getAttribute("e");
						%>
						<input type="hidden" name="task" value="edit" /> <input
							type="hidden" name="id" value="<%=e.getMaDonHang()%>" />

						<div class="form-group">
							<label class="control-label col-md-2">Tình trạng giao
								hàng</label>
							<div class="col-md-10">
								<select name="status" style="width: 300px; height: 35px;">
									<%
										if (e.isTinhTrangGiaoHang() == true) {
									%>
									<option value="true" selected="selected">Đã giao hàng</option>
									<option value="false">Chưa giao hàng</option>
									<%
										} else {
									%>
									<option value="true">Đã giao hàng</option>
									<option value="false" selected="selected">Chưa giao
										hàng</option>
									<%
										}
									%>
						...
						<div class="form-group">
							<div class="col-md-offset-2 col-md-10">
								<a href="<%=request.getContextPath()%>/admin/orderform"
