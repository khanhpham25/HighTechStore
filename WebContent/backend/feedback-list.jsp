					...
					<div class="x_panel">
						...
						<div class="x_content">
							<table id="datatable-buttons"
								...
								<tbody>
									<%
										ArrayList<PhanHoi> list = (ArrayList<PhanHoi>) request.getAttribute("list");
										for (int i = 0; i < list.size(); i++) {
									%>
									<tr>
										<td><%=list.get(i).getMaPhanHoi()%></td>
										<%
											KhachHang e = CustomerDAO.getById(list.get(i).getMaKhachHang());
										%>
										<td><%=e.getHoTen()%></td>
										<%
										...
										<td width="200px;"><a
											...
											href="<%=request.getContextPath()%>/admin/feedback?task=delete&id=<%=list.get(i).getMaPhanHoi()%>"
