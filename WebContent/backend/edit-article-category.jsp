		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="form-horizontal">
					...
					<hr />
					<form method="post"
						action="<%=request.getContextPath()%>/admin/article-category">
						<%
							DanhMucBaiViet e = (DanhMucBaiViet) request.getAttribute("e");
						%>
						<input type="hidden" name="task" value="edit" /> <input
							type="hidden" name="id" value="<%=e.getMaDanhMuc()%>" />
						<div class="form-group">
							...
							<div class="col-md-10">
								<input type="text" name="name" required="required" autocomplete="off"
									...
									value="<%=e.getTenDanhMuc()%>" />
							</div>
						</div>

						<div class="form-group">
							<div class="col-md-offset-2 col-md-10">
								<a href="<%=request.getContextPath()%>/admin/article-category"
