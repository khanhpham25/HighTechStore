...
<%@page import="mta.cnpm12.store.dao.CustomerDAO"%>
							...
							<table id="datatable-buttons"
								...
								<tbody>
									...
									<tr>
										...
										<%
											KhachHang ctm = CustomerDAO.getById(list.get(i).getMaKhachHang());
										%>
										<td><%=ctm.getHoTen()%></td>
										<%
											if (list.get(i).getGhiChu() != null) {
										%>
										...
										<%
											if (list.get(i).isTinhTrangGiaoHang() == true) {
										%>
										<td>Đã giao hàng</td>
										<%
											} else {
										...
										%>
										<td width="200px;"><a
											href="<%=request.getContextPath()%>/admin/orderform?task=detail&id=<%=list.get(i).getMaDonHang()%>"
											class="btn btn-success">Chi tiết</a> <a
											href="<%=request.getContextPath()%>/admin/orderform?task=edit&id=<%=list.get(i).getMaDonHang()%>"
											class="btn btn-primary">Sửa</a> <a
											href="<%=request.getContextPath()%>/admin/orderform?task=delete&id=<%=list.get(i).getMaDonHang()%>"
