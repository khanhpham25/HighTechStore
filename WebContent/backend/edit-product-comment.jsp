		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="form-horizontal">
					<h4>Sửa bình luận sản phẩm</h4>
					<hr />
					<form method="post"
						action="<%=request.getContextPath()%>/admin/product-comment">
						<%
							BinhLuanSanPham e = (BinhLuanSanPham) request.getAttribute("e");
						%>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<%
									ArrayList<SanPham> ds = (ArrayList<SanPham>) request.getAttribute("ds");
								%>
								<select name="product" style="width: 300px; height: 35px;">
									<%
										for (int i = 0; i < ds.size(); i++) {
											if (ds.get(i).getMaSP() == e.getMaSP()) {
									%>
									<option value="<%=ds.get(i).getMaSP()%>" selected="selected"><%=ds.get(i).getTenSP()%></option>
									<%
										} else {
									%>
									<option value="<%=ds.get(i).getMaSP()%>"><%=ds.get(i).getTenSP()%></option>
									<%
										}
										}
									%>
						...
						<div class="form-group">
							<div class="col-md-offset-2 col-md-10">
								<a href="<%=request.getContextPath()%>/admin/product-comment"
