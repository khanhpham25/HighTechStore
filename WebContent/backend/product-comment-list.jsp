					...
					<div class="x_panel">
						...
						<div class="x_content">
							<table id="datatable-buttons"
								...
								<tbody>
									<%
										ArrayList<BinhLuanSanPham> list = (ArrayList<BinhLuanSanPham>) request.getAttribute("list");
									...
									<tr>
										...
										%>
										<td width="120px;"><a
											href="<%=request.getContextPath()%>/admin/product-comment?task=edit&id=<%=list.get(i).getMaBinhLuan()%>"
											class="btn btn-primary">Sửa</a> <a
											href="<%=request.getContextPath()%>/admin/product-comment?task=delete&id=<%=list.get(i).getMaBinhLuan()%>"
